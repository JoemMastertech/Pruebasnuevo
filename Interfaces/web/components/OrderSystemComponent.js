...
exports.OrderSystemComponent = void 0;
const OrderPresenter_1 = require("../presenters/OrderPresenter");
const EventHandler_1 = require("../events/EventHandler");
const ProductPresenter_1 = require("../presenters/ProductPresenter");
class OrderSystemComponent {
    ...
    config = {}) {
        try {
            ...
            const orderPresenter = new OrderPresenter_1.OrderPresenter();
            const productController = container.resolve('ProductController');
            const productPresenter = new ProductPresenter_1.ProductPresenter();
...
exports.OrderSystemComponent = OrderSystemComponent;

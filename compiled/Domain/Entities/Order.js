...
const OrderId_js_1 = require("../ValueObjects/OrderId.js");
const Money_js_1 = require("../ValueObjects/Money.js");
/**
...
class Order {
    constructor(id, customerId) {
        ...
        this.items = [];
        this._total = Money_js_1.Money.zero();
    ...
    static create(customerId) {
        const orderId = OrderId_js_1.OrderId.generate();
     ...
     */
    calculateTotal() {
        this._total = this.items.reduce((sum, item) => sum.add(item.getSubtotal()), Money_js_1.Money.zero());
    }
    /**

...
exports.UIIntegrationTestSuite = void 0;
const OrderController_1 = require("../../../Interfaces/web/controllers/OrderController");
const ProductController_1 = require("../../../Interfaces/web/controllers/ProductController");
const OrderPresenter_1 = require("../../../Interfaces/web/presenters/OrderPresenter");
const ProductPresenter_1 = require("../../../Interfaces/web/presenters/ProductPresenter");
const EventHandler_1 = require("../../../Interfaces/web/events/EventHandler");
const OrderSystemComponent_1 = require("../../../Interfaces/web/components/OrderSystemComponent");
const ProductGridComponent_1 = require("../../../Interfaces/web/components/ProductGridComponent");
const PerformanceOptimizer_1 = require("../../../Interfaces/web/performance/PerformanceOptimizer");
...
class UIIntegrationTestSuite {
    ...
    setupComponents() {
        ...
        this.orderPresenter = new OrderPresenter_1.OrderPresenter();
        this.productPresenter = new ProductPresenter_1.ProductPresenter();
        // Configurar controladores con casos de uso específicos
        this.orderController = new OrderController_1.OrderController(this.container.resolve('CreateOrderUseCase'), this.container.resolve('AddProductToOrderUseCase'), this.container.resolve('ValidateOrderUseCase'), this.orderPresenter);
        this.productController = new ProductController_1.ProductController(this.container.resolve('GetProductsUseCase'), this.container.resolve('GetProductByIdUseCase'), this.productPresenter);
        ...
        this.orderSystemComponent = new OrderSystemComponent_1.OrderSystemComponent(this.orderController, this.orderPresenter, this.productController, this.productPresenter, { autoStart: true, enableLogging: true });
        this.productGridComponent = new ProductGridComponent_1.ProductGridComponent(this.productController, this.productPresenter, { enableVirtualization: true, enableLazyLoading: true });
...
exports.UIIntegrationTestSuite = UIIntegrationTestSuite;

...
export default class SupabaseAdapter extends BaseAdapter {
    ...
    async getProducts(type) {
        ...
        return this.safeExecuteAsync(() => this.client
            .from('products')
            .select('*')
            .eq('category', type)
            .order('price', { ascending: true }), 'getProducts', []).then(result => result?.data || []);
    }
    /**
    ...
    async getAllCocktails() {
        const result = await this.safeExecuteAsync(() => this.client
            ...
            .order('nombre', { ascending: true }), 'getAllCocktails', []);
        return result?.data || [];
    }
    /**
    ...
    async getProductsByCategory(category) {
        ...
        return this.safeExecuteAsync(() => this.client
            ...
            .order('nombre', { ascending: true }), 'getProductsByCategory', []).then(result => result?.data || []);
    }
}

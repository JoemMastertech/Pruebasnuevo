 ...
 */
export class ProductDataRepositoryAdapter {
    ...
    convertToDomainModel(rawProduct, category) {
        ...
        const ingredients = rawProduct.ingredientes ?
            ...
            '';
        // Crear el producto
        return new Product(id, name, productCategory, productPrice, ingredients);
    }
    /**
...
//# sourceMappingURL=ProductDataRepositoryAdapter.js.map
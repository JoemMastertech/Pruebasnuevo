...
class SimpleControllerTests {
    ...
    setupTestEnvironment() {
        try {
            ...
            const getProductsUseCase = this.container.resolve('GetProductsUseCase');
            const getProductByIdUseCase = this.container.resolve('GetProductByIdUseCase');
            // Crear controladores
            this.orderController = new OrderController(createOrderUseCase, addProductToOrderUseCase, validateOrderUseCase, this.orderPresenter);
            this.productController = new ProductController(getProductsUseCase, getProductByIdUseCase, this.productPresenter);
...
//# sourceMappingURL=SimpleControllerTests.js.map
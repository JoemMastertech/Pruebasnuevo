        ...
        this.state.filteredProducts.sort((a, b) => {
            ...
            switch (field) {
                ...
                case 'price':
                    ...
                    break;
                case 'category':
                    aValue = a.getCategory().getValue().toLowerCase();
                    bValue = b.getCategory().getValue().toLowerCase();
                    break;
                default:
                    return 0;
            }
    ...
    filterProducts(filters) {
        ...
        this.state.filteredProducts = this.state.products.filter(product => {
            ...
            if (filters.category && filters.category !== '') {
                if (product.getCategory().getValue() !== filters.category) {
                    return false;
                }
            }
...
//# sourceMappingURL=ProductGridComponent.js.map
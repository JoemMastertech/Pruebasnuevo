...
const ScreenManager = {
    ...
    async startWelcomeSequence() {
        ...
        try {
            ...
            await this.transitionScreen(welcomeScreen, logoScreen, '🔄 Transitioning from welcome to logo screen');
            ...
            await this.transitionScreen(logoScreen, categoryTitleScreen, '🔄 Transitioning from logo to category screen');
            ...
            await this.transitionScreen(categoryTitleScreen, mainContentScreen, '🔄 Transitioning to main content screen');

...
const ProductRenderer = {
    ...
    renderLiquorCategory: async function (container, subcategory, title) {
        ...
        try {
            ...
            if (this.currentViewMode === 'grid') {
                this.createProductGrid(container, data, liquorFields, title);
            }
            else {
                this.createProductTable(container, liquorHeaders, data, liquorFields, 'liquor-table', title);
            }
    ...
    renderDigestivos: async function (container, title = 'Digestivos') {
        ...
        try {
            ...
            if (this.currentViewMode === 'grid') {
                this.createProductGrid(container, data, ['nombre', 'imagen', 'precioBotella', 'precioLitro', 'precioCopa'], title);
            }
            else {
                this.createProductTable(container, ['NOMBRE', 'IMAGEN', 'PRECIO BOTELLA', 'PRECIO LITRO', 'PRECIO COPA'], data, ['nombre', 'imagen', 'precioBotella', 'precioLitro', 'precioCopa'], 'liquor-table', title);
            }
        }
        catch (error) {
            logError(`Error rendering ${title}:`, error);
    ...
    renderCervezas: async function (container) {
        ...
        try {
            ...
            if (this.currentViewMode === 'grid') {
                this.createProductGrid(container, data, ['nombre', 'ruta_archivo', 'precio'], 'Cervezas');
            }
            else {
                this.createProductTable(container, ['NOMBRE', 'IMAGEN', 'PRECIO'], data, ['nombre', 'ruta_archivo', 'precio'], 'product-table', 'Cervezas');
            }
        }
        catch (error) {
    ...
    renderPizzas: async function (container) {
        ...
        try {
            ...
            if (this.currentViewMode === 'grid') {
                this.createProductGrid(container, data, ['nombre', 'ingredientes', 'video', 'precio'], 'Pizzas');
            }
            else {
                this.createProductTable(container, ['NOMBRE', 'INGREDIENTES', 'VIDEO', 'PRECIO'], data, ['nombre', 'ingredientes', 'video', 'precio'], 'product-table', 'Pizzas');
            }
        }
        catch (error) {
    ...
    renderFoodCategory: async function (container, methodName, title, fields = null, headers = null) {
        ...
        try {
            ...
            if (this.currentViewMode === 'grid') {
                this.createProductGrid(container, data, finalFields, title);
            }
            else {
                this.createProductTable(container, finalHeaders, data, finalFields, 'product-table', title);
            }
        }
        catch (error) {
            logError(`Error rendering ${title}:`, error);
    ...
    renderRefrescos: async function (container) {
        await this.renderFoodCategory(container, 'getRefrescos', 'Refrescos', ['nombre', 'ruta_archivo', 'precio'], ['NOMBRE', 'IMAGEN', 'PRECIO']);
    },

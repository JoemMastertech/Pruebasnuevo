...
export class ProductController {
    ...
    async getProductsByCategory(categoryName) {
        try {
            ...
            if (result.isSuccess()) {
                ...
                const filteredProducts = allProducts.filter(product => product.getCategory().getValue() === category.getValue());
        ...
        try {
            ...
            if (result.isSuccess()) {
                ...
                if (filter.category) {
                    ...
                    filteredProducts = filteredProducts.filter(product => product.getCategory().getValue() === category.getValue());
                }
    ...
    async getAvailableCategories() {
        try {
            ...
            if (result.isSuccess()) {
                const products = result.getValue();
                const categories = [...new Set(products.map(p => p.getCategory().getValue()))];

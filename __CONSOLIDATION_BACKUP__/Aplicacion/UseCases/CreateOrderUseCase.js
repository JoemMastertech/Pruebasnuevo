...
class CreateOrderUseCase {
    ...
    async getCurrentOrder() {
        ...
        if (!currentOrder) {
            ...
            const orderCreatedEvent = EventBusPort_js_1.DomainEventFactory.createOrderCreatedEvent(currentOrder.id.value);
    ...
    async addProductToOrder(productData) {
        ...
        const productAddedEvent = EventBusPort_js_1.DomainEventFactory.createProductAddedToOrderEvent(order.id.value, product.id.value, product.name.value, productData.quantity, product.price.toNumber());
